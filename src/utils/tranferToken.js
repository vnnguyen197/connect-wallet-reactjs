...
const TransferToken = async ({ sender }, receiver, amount) => {
    //get nonce
    const nonce = web3.eth.getTransactionCount(Account, "latest");
    //convert Eth to wei
    ...
    const tokenContract = new web3.eth.Contract(abi, receiver);
    //create transaction data
    const data = tokenContract.methods.transfer(sender, value).encodeABI();
    ...
    const signTrx =  web3.eth.accounts.signTransaction(transaction, PrivateKey);
